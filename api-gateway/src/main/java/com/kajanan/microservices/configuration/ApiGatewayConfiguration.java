package com.kajanan.microservices.configuration;
...
public class ApiGatewayConfiguration {
	...
	public RouteLocator gatewayRouter(RouteLocatorBuilder builder) {
		return builder.routes()
				...
				.route(p -> p.path("/currency-conversion-service/**").uri("lb://currency-conversion"))
				.route(p -> p.path("/currency-conversion-service-feign/**").uri("lb://currency-conversion")).route(
						p -> p.path("/currency-conversion-service-new/**")
